...
%设置标题格式%
\DeclareCaptionFont{xiaowusong}{\zihao{-5}} % 定义“小五宋”格式
\captionsetup{font=xiaowusong} % 将此格式应用于所有题注
% 尝试在此处立即重定义
% ... 文档其余部分 ...
%===========================================================%
\begin{document}
...
\begin{comment}
terminal运行命令
xelatex -interaction=nonstopmode CjC_template_tex
bibtex CjC_template_tex
xelatex -interaction=nonstopmode CjC_template_tex
xelatex -interaction=nonstopmode CjC_template_tex
\end{comment}
...
\bibliography{ref,ref/RaoDongDuiMoXingYingXiang}
